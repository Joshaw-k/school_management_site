    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'AdminHod'), (2, 'Staff'), (3, 'Student')], default=1, max_length=40)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_year', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.sessionyear')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('attendance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.attendance')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.student')),
            ],
        ),
        migrations.AddField(
            ...
            name='session_year',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.sessionyear'),
        ),
        migrations.AddField(
            model_name='attendance',
            name='subject',
